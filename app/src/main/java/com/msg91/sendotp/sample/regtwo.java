...
public class regtwo extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i=getIntent();
        farm=findViewById(R.id.fname123);
        ...
        dancetype=findViewById(R.id.room);
...
//                startActivityForResult(intent,IMAGE_PICK_CODE);
    ...
    public void registerButtonf(View view) { {
        ...
        if (farm.getText().toString().isEmpty()){

            farm.setError("Empty Field");
        }
...

        {
            class UploadImage extends AsyncTask<Bitmap, Void, String> {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    loading = ProgressDialog.show(regtwo.this, "Uploading...", null, true, false);
                }
                                        ...
                                        sDialog
                                                ...
                                                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                                    ...
                                                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                                                        Intent in=new Intent(regtwo.this,Signinadmin.class);
                                                        startActivity(in);
                                                    }
                                                })
...
//
                ...
                protected String doInBackground(Bitmap... params) {
                    ...
                    data.put("f",farm.getText().toString());
                    ...
                    String result = rh.sendPostRequest("https://androidprojectstechsays.000webhostapp.com/Orphanage_manegument_system/admin_registration.php", data);
